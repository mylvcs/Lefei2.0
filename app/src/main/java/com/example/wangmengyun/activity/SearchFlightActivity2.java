...
//
//
////TODO activity2 only arriveCity
//
...
//
//                if (getArriveResult.hasExtra(Intent.EXTRA_COMPONENT_NAME)) {
...
////        Intent getArriveResult = getIntent();
////
////        if (getArriveResult.hasExtra(Intent.EXTRA_REFERRER)){
////            String textEntered = getArriveResult.getStringExtra(Intent.EXTRA_REFERRER);
////            arriveCity.setText(textEntered);
////        }
//
//
