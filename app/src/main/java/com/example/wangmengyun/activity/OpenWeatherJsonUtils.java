...
//     * function, leveraging the data we have stored in the JSON. For
...
//     */
//    public static String[] getWeatherContentValuesFromJson(Context context, String forecastJsonStr)
