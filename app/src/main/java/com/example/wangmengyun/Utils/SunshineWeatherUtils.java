...
//
//
//    public static String formatHighLows(Context context, String departure, String arrival) {
//
//
//        String formattedHigh = formatTemperature(context, departure);
//        String formattedLow = formatTemperature(context, arrival);
//
